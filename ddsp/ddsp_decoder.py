...
class DDSPDecoder(nn.Module):
    ...
    def forward(self, f0, loudness):
        ...
        amplitude_tensor =  self.modified_sigmoid(self.dense_amplitudes(final_mlp_output)) # values in [0,2], shape: [batch, frames, num_harmonics]
        H = self.modified_sigmoid(self.dense_filter_coeffs(final_mlp_output)) # values in [0,2]
        ...
        harm_distr =  amplitude_tensor[..., 1:] # Removed the softmax (see above), moved this normalization to harmonic oscillator
